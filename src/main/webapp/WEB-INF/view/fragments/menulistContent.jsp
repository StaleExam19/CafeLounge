<div class="menulist">
    ...
    <div class="menu-card" data-menu-card-id="${item.id}">
        <div class="flex justify-between">
            ...
            <svg class="group" data-info-toggle="${item.id}"="" width="24" height="24" fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="group" data-update-menu-id="${item.id}">
            <svg  width="24" height="24" fill="none" viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg" data-update-menu-id="${item.id}">
