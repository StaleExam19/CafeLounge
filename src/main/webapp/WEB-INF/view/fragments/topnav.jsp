    ...
    <%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
        ...
        <div class="h-24 w-full justify-between flex items-center px-12">
            ...
            <div class="flex gap-5">
                ...
                <!-- Menu Search section -->
                <c:if test="${menuSearch}">
                    <div>
                        <div class="bg-white border-2 flex items-center relative  px-2 border-black rounded-2xl">
                                <input type="text" placeholder="Search by menu name" id="menu-search-input"
                                class="p-2 w-96 rounded-2xl outline-none placeholder:text">
                            <div>
