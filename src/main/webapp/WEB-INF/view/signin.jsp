...
<body >
    <div class="bg-[url('resources/image/background.jpg')] bg-cover bg-no-repeat justify-items-center ">
        <div class="bg-zinc-950/40 min-h-screen ">
            ...
            <form:form class="flex justify-center items-center pt-32" action="${signinRoute}" method="post" modelAttribute="userForm">
                <div>
                    ...
                    <br>
                    <form:input type="text" path="username" placeholder="Username" class="p-2 w-96 items-start rounded-2xl" />
                    <br><br>    
